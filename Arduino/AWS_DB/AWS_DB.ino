...
int average = 60; // Averaing over one minute
float end_time = 0;
...
//    Serial.println(uvLevel);
  ...
  Serial.print(dallas_0/count);
  Serial.println();
  
  Serial.print("Temperature Dallas 1: "); 
  Serial.print(dallas_1/count);
  Serial.println();
  
  Serial.print("UV Intensity (mW/cm^2): ");
  Serial.print(uvIntensity/count);
  ...
  //Print complete date:
  String currentDate = String(currentMonth) + "/" + String(monthDay) + "/" + String(currentYear)+ "-" + String(currentHour) + ":" + String(currentMinute)+ ":" + String(currentSecond);

  String macIdStr = mac_Id;
  
  snprintf (msg, BUFFER_LEN, "{\"Time\" : \"%s\",\"Temperature\" : %f, \"Humidity\" : %f, \"UV_Intensity\" : %f, \"Dallas1\" : %f, \"Dallas2\" : %f, \"Wind_Speed\" : %f}",currentDate.c_str(),temperature/count, humidity/count, uvIntensity/count, dallas_0/count, dallas_1/count, wind_speed/60);
//  snprintf (msg, 75, "{\"Temperature\": %f, \"Humidity\": %f, \"time\": \"%s\"}", temperature/average, humidity/average, currentDate.c_str());
